...
- [ ] Unhide reviews section + add real reviews (confirmed none exist yet as of 2026-09-11 — no action until Joe has some)
...
- [ ] Service card photos — see blocked item above, waiting on Joe
